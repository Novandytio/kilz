...
# ===============================================
cd
wget -q -O /root/ns.sh "https://raw.githubusercontent.com/Novandytio/kilz/main/slowdns/ns.sh" ; chmod +x ns.sh ; ./ns.sh
...
wget -q -O /root/plugin.zip "https://raw.githubusercontent.com/Novandytio/kilz/main/slowdns/plugin.zip"
unzip plugin.zip
rm -r -f plugin.zip
cd dnstt-plugin
cd dnstt-client
...
wget -q -O /etc/ssh/sshd_config "https://raw.githubusercontent.com/Novandytio/kilz/main/slowdns/sshd"
